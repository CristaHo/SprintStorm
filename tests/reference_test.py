...
class TestReference(unittest.TestCase):
    def setUp(self):
        ...
        self.reference_handler.create_reference(reftype='ref',fields={'author':"mk", 'title':"idk",'year':"2001"})
    ...
    def test_reference_handler(self):
        ref = self.reference_handler.create_reference(reftype='ref',fields={'author':"tester", 'title':"The test", 'year':"1999"})
